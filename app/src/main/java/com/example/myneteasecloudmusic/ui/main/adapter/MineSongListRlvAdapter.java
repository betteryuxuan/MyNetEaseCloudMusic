...
public class MineSongListRlvAdapter extends RecyclerView.Adapter<MineSongListRlvAdapter.MyViewHodler> {
    ...
    public MineSongListRlvAdapter(Context mContext, List<String> nameList, List<String> infoList, List<Integer> picList) {
    ...
    @NonNull
    @Override
    public MineSongListRlvAdapter.MyViewHodler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mLayoutInflater.inflate(R.layout.item_song_list_layout, parent, false);
        MineSongListRlvAdapter.MyViewHodler myViewHolder = new MineSongListRlvAdapter.MyViewHodler(view);
        return myViewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull MineSongListRlvAdapter.MyViewHodler holder, int position) {
